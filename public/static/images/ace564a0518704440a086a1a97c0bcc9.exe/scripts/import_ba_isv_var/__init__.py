...
ATTRIBUTE_FIELDS = ['isv_start_date', 'isv_end_date', 'var_start_date', 'var_end_date']

ba_isv_var_to_dyn_mapping = {
    'isv_start_date': 'isv_start_date',
    'isv_end_date': 'isv_end_date',
...
def main(ba_table_path, dyn_table_path, proxy, loglevel):
    ...
    for src_row in yt.read_table(ba_table_path):
